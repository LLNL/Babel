...
export CC="pgcc"
export PROFILE_NAME="techx-linux-${CC}-${F77}-${FORTRAN}.profile"
...
export CONFIG_FLAGS="--enable-java=/usr/local/contrib/jdk1.6.0_16 JAR=/usr/local/contrib/jdk1.6.0_16/bin/jar --disable-shared --enable-static --with-pic --enable-fortran03=no --enable-pthreads=no"
