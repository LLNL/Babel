#!/bin/sh
# 
# Profile: ornl-rhel4-gcc-gfortran-jeeem-dbg.profile
#
...
export JNI_INCLUDES='/usr/lib/jvm/java-1.5.0-sun/include/'
...
export PROFILE_NAME="ornl-rhel4-gcc${GCCVERSION}-gfortran-jeeem-dbg"
