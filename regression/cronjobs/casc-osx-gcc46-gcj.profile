#!/bin/sh
# 
# Profile: casc-osx-gcc46-gcj.profile
#
...
export JNI_INCLUDES=/sw64/lib/gcc4.6/lib/gcc/x86_64-apple-darwin10.8.0/4.6.1/include/
export JAVAPREFIX=/sw64/lib/gcc4.6
export JAVAC=/sw64/bin/ecj
export JAVA=gij-fsf-4.6
...
export PROFILE_NAME="casc-osx-gcc46-gcj.profile"
