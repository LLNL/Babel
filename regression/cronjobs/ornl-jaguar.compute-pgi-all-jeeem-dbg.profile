#!/bin/sh
# 
# Profile: ornl-jaguar.compute-pgi-all-jeeem-dbg.profile
#
...
# Use Jaguar wrapper compilers (cc, CC) for compute nodes...
export CC=cc
export CFLAGS='-g'
export CXX=CC
export CXXFLAGS='-g --no_using_std'

# Use Jaguar wrapper compiler (ftn) for compute nodes...
# fortran...
export F77=ftn
export FFLAGS=-g
...
export PROFILE_NAME="ornl-jaguar.compute-pgi${PGIVERSION}-all-jeeem-dbg"
