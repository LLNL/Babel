#!/bin/sh
# 
# Profile: ornl-gentoo-gcc-nofort-jeeem-dbg.profile
#
...
# not doing fortran...
# use --disable-fortran77 and --disable-fortran90 flags  :-D
# export F77=
# export FFLAGS=-g

export PROFILE_NAME="ornl-gentoo-gcc${GCCVERSION}-nofort-jeeem-dbg"
