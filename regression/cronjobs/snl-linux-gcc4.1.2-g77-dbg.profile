...
export PROFILE_NAME="snl-linux-gcc4.1.2-g77-dbg.profile"
...
export PACKAGING_BUILDDIR=${HOME}/babel_testing/obj-trunk-regression-nof90
...
#
# . setup/casc-linux-absoft-dbg.sh
# This sets up pgi 6.2 f90
# but for this profile we don't want f90.

# LD_LIBRARY_PATH=/opt/pgi/linux86-64/6.2/libso:"$LD_LIBRARY_PATH"
# export FC=pgf90
# export CHASMPREFIX=$HOME/chasms/pgisocvs
# export FCFLAGS=
# export F90LIBS="-L/opt/pgi/linux86-64/6.2/libso -L/usr/lib64 -L/usr/lib64/gcc/x86_64-suse-linux/4.1.2/  -lpgf90 -lpgf90_rpm1 -lpgf902 -lpgf90rtl -lpgftnrtl -lnspgc -lpgc -lm"
# export FCLIBS="-L/opt/pgi/linux86-64/6.2/libso -L/usr/lib64 -L/usr/lib64/gcc/x86_64-suse-linux/4.1.2/  -lpgf90 -lpgf90_rpm1 -lpgf902 -lpgf90rtl -lpgftnrtl -lnspgc -lpgc -lm"


#
# . setup/casc-linux-final.sh
# Settings that should be at the end of the setup
export CONFIG_FLAGS="--disable-shared --without-sidlx"
