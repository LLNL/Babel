...
export PROFILE_NAME="snl-linux-gcc4.1.2-pgf90-dbg.profile"
...
export PACKAGING_BUILDDIR=${HOME}/babel_testing/obj-trunk-regression
...
export CONFIG_FLAGS="--disable-static --without-sidlx --with-F90-vendor=PGI"
