IMPLSRCS = sorting_CompInt_Impl.f sorting_Heapsort_Impl.f                     \
  sorting_IntegerContainer_Impl.f sorting_Integer_Impl.f                      \
  sorting_Mergesort_Impl.f sorting_Quicksort_Impl.f                           \
  sorting_SimpleCounter_Impl.f sorting_SortTest_Impl.f                        \
  sorting_SortingAlgorithm_Impl.f
...
STUBDOCS = sorting_CompInt.fif sorting_Comparator.fif sorting_Container.fif   \
  sorting_Counter.fif sorting_Heapsort.fif sorting_Integer.fif                \
  sorting_IntegerContainer.fif sorting_Mergesort.fif sorting_Quicksort.fif    \
  sorting_SimpleCounter.fif sorting_SortTest.fif sorting_SortingAlgorithm.fif
STUBHDRS = sorting_CompInt_fStub.h sorting_Comparator_fStub.h                 \
  sorting_Container_fStub.h sorting_Counter_fStub.h sorting_Heapsort_fStub.h  \
  sorting_IntegerContainer_fStub.h sorting_Integer_fStub.h                    \
  sorting_Mergesort_fStub.h sorting_Quicksort_fStub.h                         \
  sorting_SimpleCounter_fStub.h sorting_SortTest_fStub.h                      \
  sorting_SortingAlgorithm_fStub.h
