! 
! File:          sorting_SortTest_Impl.F90
...
recursive subroutine sorting_SortTest__ctor_mi(self, exception)
  use sidl
  use sidl_BaseInterface
  use sidl_RuntimeException
  use sorting_SortTest
  use sorting_SortTest_impl
...
end subroutine sorting_SortTest__ctor_mi
...
recursive subroutine sorting_SortTest__ctor2_mi(self, private_data, exception)
  use sidl
  use sidl_BaseInterface
  use sidl_RuntimeException
  use sorting_SortTest
  use sorting_SortTest_impl
  ! DO-NOT-DELETE splicer.begin(sorting.SortTest._ctor2.use)
  ! Insert-Code-Here {sorting.SortTest._ctor2.use} (use statements)
  ! DO-NOT-DELETE splicer.end(sorting.SortTest._ctor2.use)
  implicit none
  type(sorting_SortTest_t) :: self
  ! in
  type(sorting_SortTest_wrap) :: private_data
  ! in
  type(sidl_BaseInterface_t) :: exception
  ! out

! DO-NOT-DELETE splicer.begin(sorting.SortTest._ctor2)
! Insert-Code-Here {sorting.SortTest._ctor2} (_ctor2 method)
! DO-NOT-DELETE splicer.end(sorting.SortTest._ctor2)
end subroutine sorting_SortTest__ctor2_mi
...
recursive subroutine sorting_SortTest__dtor_mi(self, exception)
  use sidl
  use sidl_BaseInterface
  use sidl_RuntimeException
  use sorting_SortTest
...
end subroutine sorting_SortTest__dtor_mi
...
recursive subroutine sorting_SortTest__load_mi(exception)
  use sidl
  use sidl_BaseInterface
  use sidl_RuntimeException
  use sorting_SortTest
...
end subroutine sorting_SortTest__load_mi
...
recursive subroutine sorting_SortTest_stressTest_mi(algs, retval, exception)
  use sidl
  use sidl_BaseInterface
  use sidl_RuntimeException
  use sorting_SortTest
...
end subroutine sorting_SortTest_stressTest_mi
