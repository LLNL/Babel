FSKELSRCS = Exceptions_FibException_fSkelf.F03 Exceptions_Fib_fSkelf.F03      \
  Exceptions_NegativeValueException_fSkelf.F03                                \
  Exceptions_TooBigException_fSkelf.F03 Exceptions_TooDeepException_fSkelf.F03
IMPLSRCS = Exceptions_FibException_Impl.F03 Exceptions_Fib_Impl.F03           \
  Exceptions_NegativeValueException_Impl.F03                                  \
  Exceptions_TooBigException_Impl.F03 Exceptions_TooDeepException_Impl.F03
...
STUBMODULESRCS = Exceptions_Fib.F03 Exceptions_FibException.F03               \
  Exceptions_NegativeValueException.F03 Exceptions_TooBigException.F03        \
  Exceptions_TooDeepException.F03
...
TYPEMODULESRCS = Exceptions_FibException_type.F03 Exceptions_Fib_type.F03     \
  Exceptions_NegativeValueException_type.F03                                  \
  Exceptions_TooBigException_type.F03 Exceptions_TooDeepException_type.F03
...
_deps_Exceptions_FibException_fSkelf =  Exceptions_FibException_Impl          \
  Exceptions_FibException_type
Exceptions_FibException_fSkelf$(MOD_SUFFIX) : $(addsuffix $(MOD_SUFFIX), $(_deps_Exceptions_FibException_fSkelf))
...
_deps_Exceptions_Fib_fSkelf =  Exceptions_Fib_Impl Exceptions_Fib_type        \
  Exceptions_FibException_type Exceptions_NegativeValueException_type
Exceptions_Fib_fSkelf$(MOD_SUFFIX) : $(addsuffix $(MOD_SUFFIX), $(_deps_Exceptions_Fib_fSkelf))
...
_deps_Exceptions_NegativeValueException_fSkelf =                              \
  Exceptions_NegativeValueException_Impl                                      \
  Exceptions_NegativeValueException_type
Exceptions_NegativeValueException_fSkelf$(MOD_SUFFIX) : $(addsuffix $(MOD_SUFFIX), $(_deps_Exceptions_NegativeValueException_fSkelf))
...
_deps_Exceptions_TooBigException_fSkelf =  Exceptions_TooBigException_Impl    \
  Exceptions_TooBigException_type
Exceptions_TooBigException_fSkelf$(MOD_SUFFIX) : $(addsuffix $(MOD_SUFFIX), $(_deps_Exceptions_TooBigException_fSkelf))
...
_deps_Exceptions_TooDeepException_fSkelf =  Exceptions_TooDeepException_Impl  \
  Exceptions_TooDeepException_type
Exceptions_TooDeepException_fSkelf$(MOD_SUFFIX) : $(addsuffix $(MOD_SUFFIX), $(_deps_Exceptions_TooDeepException_fSkelf))
