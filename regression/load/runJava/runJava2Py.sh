...
if test -f stamp-installcheck; then
  ...
  SIDL_DLL_PATH="libClient.scl;../libPython/libImpl.scl;../libPython/libImplPy.scl;${exec_prefix}/lib/libsidl.scl;../../output/libC/libOutput.scl"
  if $cygwin; then
...
if test "X$LD_LIBRARY_PATH" = "X"; then
  ...
  LD_LIBRARY_PATH="${LD_LIBRARY_PATH}:../../../runtime/sidl/.libs:$exec_prefix/lib"
fi
