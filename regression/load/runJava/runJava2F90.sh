...
## Description: script to run Java calling F90 regression test
##
...
if test -f stamp-installcheck; then
  ...
  SIDL_DLL_PATH="libClient.scl;../libF90/libImpl.scl;${exec_prefix}/lib/libsidl.scl;../../output/libC/libOutput.scl"
  if $cygwin; then
  ...
  SIDL_DLL_PATH="libClient.scl;../libF90/libImpl.scl;../../../runtime/sidl/libsidl.scl;../../output/libC/libOutput.scl"
