...
if test -f stamp-installcheck; then
  ...
  SIDL_DLL_PATH="libClient.scl;../libCxx/libImpl.scl;${exec_prefix}/lib/libsidl.scl;../../output/libC/libOutput.scl"
  if $cygwin; then
  ...
  SIDL_DLL_PATH="libClient.scl;../libCxx/libImpl.scl;../../../runtime/sidl/libsidl.scl;../../output/libC/libOutput.scl"
