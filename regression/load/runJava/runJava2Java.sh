...
if test -f stamp-installcheck; then
  CLASSPATH="${prefix}/lib/sidl-0.9.7.jar:../libJava:."
  SIDL_DLL_PATH="../libJava/libImpl.scl;${exec_prefix}/lib/libsidl.scl;../../output/libC/libOutput.scl"
  if $cygwin; then
  ...
  CLASSPATH=../../../lib/sidl-0.9.7.jar:../libJava:../../../runtime/java:.
  SIDL_DLL_PATH="../libJava/libImpl.scl;../../../runtime/sidl/libsidl.scl;../../output/libC/libOutput.scl"
  JAVA_LIBRARY_PATH=../../../runtime/sidl/.libs
fi
