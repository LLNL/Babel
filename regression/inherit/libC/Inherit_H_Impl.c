...
/* DO-NOT-DELETE splicer.begin(Inherit.H._includes) */
/* Put additional includes or other arbitrary code here... */
/* DO-NOT-DELETE splicer.end(Inherit.H._includes) */
...
#undef __FUNC__
#define __FUNC__ "impl_Inherit_H__load"
...
#undef __FUNC__
#define __FUNC__ "impl_Inherit_H__ctor"
...
#undef __FUNC__
#define __FUNC__ "impl_Inherit_H__ctor2"
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  *_ex = 0;
  ...
  /* Insert-Code-Here {Inherit.H._ctor2} (special constructor method) */
...
#undef __FUNC__
#define __FUNC__ "impl_Inherit_H__dtor"
