#
# File:          kSizeExcept_Impl.py
# Symbol:        knapsack.kSizeExcept-v1.0
# Symbol Type:   class
# Babel Version: 2.0.0 (Revision: 7321M trunk)
# Description:   Implementation of sidl class knapsack.kSizeExcept in Python.
# 
...
# that means this Impl class is being constructed for native delegation
  def __init__(self, IORself = None):
    if (IORself == None):
      self.__IORself = knapsack.kSizeExcept.kSizeExcept(impl = self)
    else:
