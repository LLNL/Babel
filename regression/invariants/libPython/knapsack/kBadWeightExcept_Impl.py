#
# File:          kBadWeightExcept_Impl.py
# Symbol:        knapsack.kBadWeightExcept-v1.0
# Symbol Type:   class
# Babel Version: 2.0.0 (Revision: 7321M trunk)
# Description:   Implementation of sidl class knapsack.kBadWeightExcept in Python.
# 
...
# that means this Impl class is being constructed for native delegation
  def __init__(self, IORself = None):
    if (IORself == None):
      self.__IORself = knapsack.kBadWeightExcept.kBadWeightExcept(impl = self)
    else:
