...
$(TYPEMODULESRCS:.F03=.lo) $(client_TYPEMODULESRCS:.F03=.lo) : $(BASICMODULESRC:.F03=.lo)
$(ARRAYMODULESRCS:.F03=.lo)  : $(TYPEMODULESRCS:.F03=.lo)
$(STUBMODULESRCS:.F03=.lo) : $(ARRAYMODULESRCS:.F03=.lo) $(TYPEMODULESRCS:.F03=.lo) $(client_TYPEMODULESRCS:.F03=.lo)
...
babel-stamp: $(SIDLFILE) $(OUTPUTSIDL)
	...
	$(SHELL) $(BABELDIR)/$(BABEL) --client=F03 --make-prefix=client_ \
