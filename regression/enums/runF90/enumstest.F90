...
subroutine checkCars(test, python, tracker, remoteURL)
  ...
  call starttest(test)
  call passin(obj, mercedes, bRetval, throwaway)
  call reporttest(bRetval, test, python, tracker)
  ...
  call starttest(test)
  call passeverywhere(obj, mercedes, out, inout, retval, throwaway)
  ...
  call passarray(obj, array_in, array_out, array_inout, array_retval, throwaway)
  result = 1
  do i = 0, 2
...
subroutine checkNumbers(test, python, tracker, remoteURL)
  ...
  call starttest(test)
  call passin(obj, notZero, bRetval, throwaway)
  call reporttest(bRetval, test, python, tracker)
  ...
  call starttest(test)
  call passeverywhere(obj, notZero, out, inout, retval, throwaway)
