#
# File:          vDivByZeroExcept_Impl.py
# Symbol:        vect.vDivByZeroExcept-v1.0
# Symbol Type:   class
# Babel Version: 2.0.0 (Revision: 7463M trunk)
# Description:   Implementation of sidl class vect.vDivByZeroExcept in Python.
# 
...
# that means this Impl class is being constructed for native delegation
  def __init__(self, IORself = None):
    if (IORself == None):
      self.__IORself = vect.vDivByZeroExcept.vDivByZeroExcept(impl = self)
    else:
