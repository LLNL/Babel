//
// File:        LanguageWriterForJava.java
// Package:     gov.llnl.babel.backend.writers
// Revision:    @(#) $Id: LanguageWriterForJava.java 7188 2011-09-27 18:38:42Z adrian $
// Description: Java language writer for backend code generation
//
...
/**
 * Class <code>LanguageWriterForJava</code> extends the generic language
 * writer to provide additional capabilities for writing Java code.
 */
public class LanguageWriterForJava extends LanguageWriter 
  implements CodeConstants 
{
   /**
    * Create a <code>LanguageWriterForJava</code> instance that will send
    ...
    * eighty.
    */
   public LanguageWriterForJava(PrintWriter writer, Context context) {
