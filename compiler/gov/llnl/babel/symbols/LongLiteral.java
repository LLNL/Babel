//
// File:        LongLiteral.java
// Package:     gov.llnl.babel.symbols
// Revision:    @(#) $Id $
// Description: The long literal assertion expression interface.
//
...
public class LongLiteral extends Literal {
   ...
   */
  public LongLiteral(Long value, String image, Context context) 
    throws AssertionException 
  {
    super(false, context);
    if ( (image == null) || (image.equals("")) ) {
      throw new AssertionException("LongLiteral", "Cannot create a long "
  ...
  public Object accept(ExprVisitor ev, Object data) {
    return ev.visitLongLiteral(this, data);
  }
}
