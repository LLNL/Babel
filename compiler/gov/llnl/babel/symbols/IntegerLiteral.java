...
// Revision:    @(#) $Id $
// Description: The integer literal assertion expression interface.
//
...
public class IntegerLiteral extends Literal {
   ...
   */
  public IntegerLiteral(Integer value, String image, Context context) 
    throws AssertionException {
    super(false, context);
    if ( (image == null) || image.equals("") ) {
      throw new AssertionException("IntegerLiteral", "Cannot create an integer "
  ...
  public Object accept(ExprVisitor ev, Object data) {
    return ev.visitIntegerLiteral(this, data);
  }
}
