...
// Revision:    @(#) $Id $
// Description: The boolean literal assertion expression interface.
//
...
public class BooleanLiteral extends Literal {
   ...
   *                  The exception raised if an error with any validation.
   */
  public BooleanLiteral(boolean value, Context context)
  ...
  public Object accept(ExprVisitor ev, Object data) {
    return ev.visitBooleanLiteral(this, data);
  }
}
