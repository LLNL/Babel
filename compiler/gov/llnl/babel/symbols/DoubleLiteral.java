...
// Revision:    @(#) $Id $
// Description: The double literal assertion expression interface.
//
...
public class DoubleLiteral extends Literal {
   ...
   *                  The exception raised if an error during any validation.
   */
  public DoubleLiteral(Double value, String image, Context context) 
    throws AssertionException 
  {
    ...
    if ( (image == null) || (image.equals("")) ) {
      throw new AssertionException("DoubleLiteral", "Cannot create a double "
  ...
  public Object accept(ExprVisitor ev, Object data) {
    return ev.visitDoubleLiteral(this, data);
  }
}
