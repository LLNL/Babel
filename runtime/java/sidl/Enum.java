 ...
 * types.
 */
public class Enum extends sidl.Long {
  /**
   ...
   */
  public static class Array extends sidl.Long.Array {
    /*
     ...
     * instructions
     */
    public sidl.Long.Array _slice(int dimen, int[] numElem, int[] srcStart,
			int[] srcStride, int[] newStart) {
      sidl.Long.Array preCast = null;
      preCast = (sidl.Long.Array) super._slice(dimen,numElem,srcStart,
        srcStride,newStart);
      return (sidl.Long.Array)new sidl.Enum.Array(preCast.get_ior_pointer(), true);
    }
	...
	super._copy((sidl.Long.Array) dest);
    }

    
    public sidl.Long.Array _dcast() {
      try{
        int dimen = _dim();
