...
## Description:	shell script to build holder and array support in Java run-time
##

write_java() {
  cat << EOF \
  | sed -e s/CLASSNAME/$1/g -e s/TYPE/$2/g -e s/NULL/$3/g \
  > $1.java.tmp
//
// File:	CLASSNAME.java
// Package:	sidl
...
/**
 * Class <code>CLASSNAME</code> contains inner classes that
...
public class CLASSNAME {
  ...
  /**
   * Define a one dimensional array of type <code>TYPE</code>
  ...
  public static class Array extends gov.llnl.sidl.BaseArray {
     ...
     */
    static {
      gov.llnl.sidl.BaseClass._registerNatives("sidl.CLASSNAME");
    }
    ...
    public native void _set(
      int i, int j, int k, int l, int m, int n, int o, TYPE value);
  ...
  public Array _dcast() {
    try{ 
      int dimen = _dim();
      sidl.CLASSNAME.Array ret = null;
      switch (dimen) {
      case 1: 

	ret = (Array) new sidl.CLASSNAME.Array1(get_ior_pointer(),true);
        _addRef();
        return ret;
      case 2:
        ret = (Array) new sidl.CLASSNAME.Array2(get_ior_pointer(),true);
        _addRef();
        return ret;
      case 3:
        ret = (Array) new sidl.CLASSNAME.Array3(get_ior_pointer(),true);
        _addRef();
        return ret;
      case 4:
        ret = (Array) new sidl.CLASSNAME.Array4(get_ior_pointer(),true);
         _addRef();
        return ret;
      case 5:
        ret = (Array) new sidl.CLASSNAME.Array5(get_ior_pointer(),true);
        _addRef();
        return ret;
      case 6:
        ret = (Array) new sidl.CLASSNAME.Array6(get_ior_pointer(),true);
         _addRef();
        return ret;
      case 7:
        ret = (Array) new sidl.CLASSNAME.Array7(get_ior_pointer(),true);
         _addRef();
        return ret;
      default:
        return null;
   ...
   */
    ...
    */
     ...
     */
    public void _set(int i, TYPE value) {
     ...
     * invalid, then an array index out of bounds exception will be thrown.
     */
    public void set(int i, TYPE value) {
      checkBounds(i);
      _set(i, 0, 0, 0, 0, 0, 0, value);
    }
     ...
     */
    public void fromArray(TYPE[] array) {
      if (array == null) {
        destroy();
      } else {
  ...
  /**
   * Define a two dimensional array of type <code>TYPE</code>.
   * This array representation is used for sidl arrays since it requires
   * no copies to go between Java and sidl.  Explicit copies may be made
   * of the array by calling the appropriate <code>get</code> and
   * <code>set</code> methods.
  ...
  public static class Array2 extends Array {
    ...
    */
     ...
     * index is valid, then use <code>set</code> instead.
     */
    public void _set(int i, int j, TYPE value) {
  ...
  /**
   * Define a three dimensional array of type <code>TYPE</code>.
   * This array representation is used for sidl arrays since it requires
   * no copies to go between Java and sidl.  Explicit copies may be made
   * of the array by calling the appropriate <code>get</code> and
   * <code>set</code> methods.
  ...
  public static class Array3 extends Array {
     ...
     * index is valid, then use <code>get</code> instead.
     */
    public TYPE _get(int i, int j, int k) {
     ...
     * invalid, then an array index out of bounds exception will be thrown.
     */
    public TYPE get(int i, int j, int k) {
      checkBounds(i, j, k);
      return _get(i, j, k, 0, 0, 0, 0);
    }
    ...
    */
     ...
     * index is valid, then use <code>set</code> instead.
     */
    public void _set(int i, int j, int k, TYPE value) {
     ...
     * invalid, then an array index out of bounds exception will be thrown.
     */
    public void set(int i, int j, int k, TYPE value) {
      checkBounds(i, j, k);
      _set(i, j, k, 0, 0, 0, 0, value);
    }
  ...
  /**
   * Define a four dimensional array of type <code>TYPE</code>.
   * This array representation is used for sidl arrays since it requires
   * no copies to go between Java and sidl.  Explicit copies may be made
   * of the array by calling the appropriate <code>get</code> and
   * <code>set</code> methods.
  ...
  public static class Array4 extends Array {
     ...
     * index is valid, then use <code>get</code> instead.
     */
    public TYPE _get(int i, int j, int k, int l) {
     ...
     * invalid, then an array index out of bounds exception will be thrown.
     */
    public TYPE get(int i, int j, int k, int l) {
      checkBounds(i, j, k, l);
      return _get(i, j, k, l, 0, 0, 0);
    }
    ...
    */
     ...
     * index is valid, then use <code>set</code> instead.
     */
    public void _set(int i, int j, int k, int l, TYPE value) {
     ...
     * invalid, then an array index out of bounds exception will be thrown.
     */
    public void set(int i, int j, int k, int l, TYPE value) {
      checkBounds(i, j, k, l);
      _set(i, j, k, l, 0, 0, 0, value);
    }
 ...
 /**
   * Define a five dimensional array of type <code>TYPE</code>.
   * This array representation is used for sidl arrays since it requires
   * no copies to go between Java and sidl.  Explicit copies may be made
   * of the array by calling the appropriate <code>get</code> and
   * <code>set</code> methods.
  ...
  public static class Array5 extends Array {
     ...
     * index is valid, then use <code>get</code> instead.
     */
    public TYPE _get(int i, int j, int k, int l, int m) {
     ...
     * invalid, then an array index out of bounds exception will be thrown.
     */
    public TYPE get(int i, int j, int k, int l, int m) {
    ...
    */
     ...
     * index is valid, then use <code>set</code> instead.
     */
    public void _set(int i, int j, int k, int l, int m, TYPE value) {
     ...
     * invalid, then an array index out of bounds exception will be thrown.
     */
    public void set(int i, int j, int k, int l, int m, TYPE value) {
      checkBounds(i, j, k, l, m);
      _set(i, j, k, l, m, 0, 0, value);
    }
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new TYPE[u3-l3+1][];
              for (int l = l3; l <= u3; l++) {
		array[i][j][k][l] = new TYPE[u4-l4+1];
		for (int m = l4; m <= u4; m++) {
...
/**
   * Define a six dimensional array of type <code>TYPE</code>.
   * This array representation is used for sidl arrays since it requires
   * no copies to go between Java and sidl.  Explicit copies may be made
   * of the array by calling the appropriate <code>get</code> and
   * <code>set</code> methods.
  ...
  public static class Array6 extends Array {
     ...
     * index is valid, then use <code>get</code> instead.
     */
    public TYPE _get(int i, int j, int k, int l, int m, int n) {
     ...
     * invalid, then an array index out of bounds exception will be thrown.
     */
    public TYPE get(int i, int j, int k, int l, int m, int n) {
    ...
    */
     ...
     * index is valid, then use <code>set</code> instead.
     */
    public void _set(int i, int j, int k, int l, int m, int n, TYPE value) {
     ...
     * invalid, then an array index out of bounds exception will be thrown.
     */
    public void set(int i, int j, int k, int l, int m, int n, TYPE value) {
      checkBounds(i, j, k, l, m, n);
      _set(i, j, k, l, m, n, 0, value);
    }
	...
	int l5 = _lower(5);
		...
		array[i][j][k] = new TYPE[u3-l3+1][][];
		  ...
		  array[i][j][k][l] = new TYPE[u4-l4+1][];
		for (int m = l4; m <= u4; m++) {
		    array[i][j][k][l][m] = new TYPE[u4-l4+1];
		    for (int n = l5; n <= u5; n++) {
...
/**
   * Define a seven dimensional array of type <code>TYPE</code>.
   * This array representation is used for sidl arrays since it requires
   * no copies to go between Java and sidl.  Explicit copies may be made
   * of the array by calling the appropriate <code>get</code> and
   * <code>set</code> methods.
  ...
  public static class Array7 extends Array {
     ...
     * index is valid, then use <code>get</code> instead.
     */
    public TYPE _get(int i, int j, int k, int l, int m, int n, int o) {
     ...
     * invalid, then an array index out of bounds exception will be thrown.
     */
    public TYPE get(int i, int j, int k, int l, int m, int n, int o) {
    ...
    */
     ...
     * index is valid, then use <code>set</code> instead.
     */
    public void _set(int i, int j, int k, int l, int m, int n, int o, TYPE value) {
     ...
     * invalid, then an array index out of bounds exception will be thrown.
     */
    public void set(int i, int j, int k, int l, int m, int n, int o, TYPE value) {
      checkBounds(i, j, k, l, m, n, o);
	...
	int l6 = _lower(6);
		...
		for (int m = l4; m <= u4; m++) {
		  array[i][j][k][l][m] = new TYPE[u4-l4+1][];
		  for (int n = l5; n <= u5; n++) {
		    array[i][j][k][l][m][n] = new TYPE[u5-l5+1];
		    for (int o = l6; o <= u6; o++) {
...
write_java Boolean       boolean            false;
write_java Character     char               \\\'\\\\u0000\\\';
write_java DoubleComplex sidl.DoubleComplex null;
write_java Double        double             0.0;
write_java FloatComplex  sidl.FloatComplex  null;
write_java Float         float              0.0f;
write_java Integer       int                0;
write_java Long          long               0;
write_java Opaque        long               0;
write_java String        java.lang.String   null;
