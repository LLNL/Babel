...
#intFile = open('Integer.java', 'r');
enumFile = open('Enum.java', 'w');

enumFile.write(preEnum);  #Write out all the enum specific stuff
...
#    if not line:
#        break  
#    elif re.search(r'public static class Array1 extends',line):
#        enumFile.write(line)
#        line = intFile.readline()
#        while line:
#            enumFile.write(line)
