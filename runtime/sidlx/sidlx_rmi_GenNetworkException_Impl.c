...
/* Insert-Code-Here {sidlx.rmi.GenNetworkException._includes} (includes and 
  arbitrary code) */
  ...
  *_ex = 0;
  {
    ...
    /* Insert-Code-Here {sidlx.rmi.GenNetworkException._ctor} (constructor 
      method) */
    /*
     ...
     *   sidl_MemAllocException_add(ex, __FILE__, __LINE__, "sidlx.rmi.GenNetworkException._ctor", _ex);
     *   SIDL_CHECK(*_ex);
  ...
  *_ex = 0;
  {
    ...
    /* Insert-Code-Here {sidlx.rmi.GenNetworkException._dtor} (destructor 
      method) */
    /*
