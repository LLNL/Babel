...
{
  if (array) {
    static const size_t arraySize = sizeof(struct sidl_double__array)
      + (sizeof(void *) - (sizeof(struct sidl_double__array)
         ...
         struct sidl_double__array *orig)
{
  ...
  struct sidl_double__array *result = (struct sidl_double__array *)malloc(totalSize);
  ...
  if (orig) {
    ...
    ref = (struct sidl_double__array **)((char *)result + arraySize);
    *ref = orig;
