...
{
  if (array) {
    static const size_t arraySize = sizeof(struct sidl_long__array)
      + (sizeof(void *) - (sizeof(struct sidl_long__array)
         ...
         struct sidl_long__array *orig)
{
  ...
  struct sidl_long__array *result = (struct sidl_long__array *)malloc(totalSize);
  ...
  if (orig) {
    ...
    ref = (struct sidl_long__array **)((char *)result + arraySize);
    *ref = orig;
  ...
  if (data && (len > 0)) {
    ...
    if (result) {
      ...
      result->d_firstElement =
        (int64_t *)malloc((size_t)len*sizeof(int64_t));
