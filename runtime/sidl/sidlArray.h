/*
 * File:        sidlArray.h
 * Revision:    @(#) $Revision: 7401 $
 * Date:        $Date: 2011-12-02 16:20:26 -0800 (Fri, 02 Dec 2011) $
...
/**
 * Cast any sidl_***_array to a generic sidl__array.
 */
#define sidl_array_cast(array) (&((array)->d_metadata))
