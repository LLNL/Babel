...
{
  if (array) {
    static const size_t arraySize = sizeof(struct sidl_fcomplex__array)
      + (sizeof(void *) - (sizeof(struct sidl_fcomplex__array)
         ...
         struct sidl_fcomplex__array *orig)
{
  ...
  struct sidl_fcomplex__array *result = (struct sidl_fcomplex__array *)malloc(totalSize);
  ...
  if (orig) {
    ...
    ref = (struct sidl_fcomplex__array **)((char *)result + arraySize);
    *ref = orig;
  ...
  if (data && (len > 0)) {
    ...
    if (result) {
      ...
      result->d_firstElement =
        (struct sidl_fcomplex *)malloc((size_t)len*sizeof(struct sidl_fcomplex));
