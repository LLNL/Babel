...
{
  if (array) {
    static const size_t arraySize = sizeof(struct sidl_float__array)
      + (sizeof(void *) - (sizeof(struct sidl_float__array)
         ...
         struct sidl_float__array *orig)
{
  ...
  struct sidl_float__array *result = (struct sidl_float__array *)malloc(totalSize);
  ...
  if (orig) {
    ...
    ref = (struct sidl_float__array **)((char *)result + arraySize);
    *ref = orig;
  ...
  if (data && (len > 0)) {
    ...
    if (result) {
      ...
      result->d_firstElement =
        (float *)malloc((size_t)len*sizeof(float));
