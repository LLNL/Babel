...
namespace sidl { 
  ...
  public:
    ...
    array(const basearray &src) throw() 
      : Base(const_cast<sidl__array *>(src._get_baseior())) {
        if (sidl_bool_array != src.arrayType()) {
          this->d_array = NULL;
        }
        addRef();
    }
  ...
  public:
    ...
    array(const basearray &src) throw() 
      : Base(const_cast<sidl__array *>(src._get_baseior())) {
        if (sidl_char_array != src.arrayType()) {
          this->d_array = NULL;
        }
        addRef();
    }
  ...
  public:
    ...
    array(const basearray &src) throw() 
      : Base(const_cast<sidl__array *>(src._get_baseior())) {
        if (sidl_int_array != src.arrayType()) {
          this->d_array = NULL;
        }
        addRef();
    }
  ...
  public:
    ...
    array(const basearray &src) throw() 
      : Base(const_cast<sidl__array *>(src._get_baseior())) {
        if (sidl_long_array != src.arrayType()) {
          this->d_array = NULL;
        }
        addRef();
    }
  ...
  public:
    ...
    array(const basearray &src) throw() 
      : Base(const_cast<sidl__array *>(src._get_baseior())) {
        if (sidl_float_array != src.arrayType()) {
          this->d_array = NULL;
        }
        addRef();
    }
  ...
  public:
    ...
    array(const basearray &src) throw() 
      : Base(const_cast<sidl__array *>(src._get_baseior())) {
        if (sidl_double_array != src.arrayType()) {
          this->d_array = NULL;
        }
        addRef();
    }
  ...
  public:
    ...
    array(const basearray &src) throw() 
      : Base(const_cast<sidl__array *>(src._get_baseior())) {
        if (sidl_fcomplex_array != src.arrayType()) {
          this->d_array = NULL;
        }
        addRef();
    }
  ...
  public:
    ...
    array(const basearray &src) throw() 
      : Base(const_cast<sidl__array *>(src._get_baseior())) {
        if (sidl_dcomplex_array != src.arrayType()) {
          this->d_array = NULL;
        }
        addRef();
    }
  ...
  public:
    ...
    array(const basearray &src) throw() 
      : Base(const_cast<sidl__array *>(src._get_baseior())) {
        if (sidl_opaque_array != src.arrayType()) {
          this->d_array = NULL;
        }
        addRef();
    }
