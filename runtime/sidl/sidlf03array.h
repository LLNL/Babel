 ...
 * Revision:    @(#) $Revision$
 * Date:        $Date$
 * Description: Functions to convert sidl arrays into F03 derived type
 *
 */

#ifndef included_sidlf03array_h
#define included_sidlf03array_h
...
struct sidl_fortran2003_array {
  void *d_ior;
  char  d_descriptor[SIDL_MAX_F03_DESCRIPTOR];
};
...
#endif
/**
 * Convert a sidl IOR into a F03 derived type containing the IOR pointer
 * as a 64 bit integer and a F03 pointer to an array.
