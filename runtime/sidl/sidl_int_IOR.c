...
{
  if (array) {
    static const size_t arraySize = sizeof(struct sidl_int__array)
      + (sizeof(void *) - (sizeof(struct sidl_int__array)
         ...
         struct sidl_int__array *orig)
{
  ...
  struct sidl_int__array *result = (struct sidl_int__array *)malloc(totalSize);
  ...
  if (orig) {
    ...
    ref = (struct sidl_int__array **)((char *)result + arraySize);
    *ref = orig;
  ...
  if (data && (len > 0)) {
    ...
    if (result) {
      ...
      result->d_firstElement =
        (int32_t *)malloc((size_t)len*sizeof(int32_t));
