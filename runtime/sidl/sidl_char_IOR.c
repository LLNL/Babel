...
{
  if (array) {
    static const size_t arraySize = sizeof(struct sidl_char__array)
      + (sizeof(void *) - (sizeof(struct sidl_char__array)
         ...
         struct sidl_char__array *orig)
{
  ...
  struct sidl_char__array *result = (struct sidl_char__array *)malloc(totalSize);
  ...
  if (orig) {
    ...
    ref = (struct sidl_char__array **)((char *)result + arraySize);
    *ref = orig;
