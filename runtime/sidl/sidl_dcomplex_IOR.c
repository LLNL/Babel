...
{
  if (array) {
    static const size_t arraySize = sizeof(struct sidl_dcomplex__array)
      + (sizeof(void *) - (sizeof(struct sidl_dcomplex__array)
         ...
         struct sidl_dcomplex__array *orig)
{
  ...
  struct sidl_dcomplex__array *result = (struct sidl_dcomplex__array *)malloc(totalSize);
  ...
  if (orig) {
    ...
    ref = (struct sidl_dcomplex__array **)((char *)result + arraySize);
    *ref = orig;
  ...
  if (data && (len > 0)) {
    ...
    if (result) {
      ...
      result->d_firstElement =
        (struct sidl_dcomplex *)malloc((size_t)len*sizeof(struct sidl_dcomplex));
