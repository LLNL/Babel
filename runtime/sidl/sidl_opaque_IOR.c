...
{
  if (array) {
    static const size_t arraySize = sizeof(struct sidl_opaque__array)
      + (sizeof(void *) - (sizeof(struct sidl_opaque__array)
         ...
         struct sidl_opaque__array *orig)
{
  ...
  struct sidl_opaque__array *result = (struct sidl_opaque__array *)malloc(totalSize);
  ...
  if (orig) {
    ...
    ref = (struct sidl_opaque__array **)((char *)result + arraySize);
    *ref = orig;
  ...
  if (data && (len > 0)) {
    ...
    if (result) {
      ...
      result->d_firstElement =
        (void * *)malloc((size_t)len*sizeof(void *));
