 ...
 * Revision:    @(#) $Revision: 7506 $
 * Date:        $Date: 2012-12-18 09:33:43 -0800 (Tue, 18 Dec 2012) $
...
{
  if (array) {
    static const size_t arraySize = sizeof(struct sidl_interface__array)
      + (sizeof(void *) - (sizeof(struct sidl_interface__array)
         ...
         struct sidl_interface__array *orig)
{
  ...
  struct sidl_interface__array *result = (struct sidl_interface__array *)malloc(totalSize);
  ...
  if (orig) {
    ...
    ref = (struct sidl_interface__array **)((char *)result + arraySize);
    *ref = orig;
  ...
  if (data && (len > 0)) {
    ...
    if (result) {
      ...
      result->d_firstElement =
        (sidl_BaseInterface *)malloc((size_t)len*sizeof(sidl_BaseInterface));
